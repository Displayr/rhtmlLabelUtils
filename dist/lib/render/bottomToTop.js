...
var enums = require('../enums'); // TODO : respect vertical and horizontal alignment
  ...
  lines.forEach(function (line, i) {
    ...
    switch (verticalAlignment) {
      case enums.verticalAlignment.TOP:
        textElement.attr('transform', "translate(0,0),rotate(-90)").style('text-anchor', 'end');
        break;
      ...
      case enums.verticalAlignment.BOTTOM:
        textElement.attr('transform', "translate(0,".concat(height, "),rotate(-90)")).style('text-anchor', 'start');
        break;
