...
const testCases = require('../data').southEastOrientation
...
describe(`${testGroup}:`, () => {
  ...
  test('alignment combinations', async () => {
    return addTestcasesToPageAndTakeSnapshot({
      customSnapshotIdentifier: 'south-east-wrapped-label-alignment-combos',
  ...
  test('font color,weight,size,family visual test', async () => {
    return addTestcasesToPageAndTakeSnapshot({
      customSnapshotIdentifier: 'south-east-font-variation-test',
