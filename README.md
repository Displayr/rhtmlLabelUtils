...
# TODO
* (DONE) horizontal label center vertical align does not work
...
* (DONE) split snapshots into multiple directories

TO Test
* font weight / color / size rendering
* render some that push right to the edge